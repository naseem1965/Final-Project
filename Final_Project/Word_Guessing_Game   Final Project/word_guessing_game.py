...
pygame.display.set_caption("GUESS GENIUS")
...
button3 =   pygame.image.load("heart.png")  
...
def startScreen():
    ...
    heading = wordGuessFont.render("GUESS GENIUS", True, yellow)
    gameDisplay.blit(heading, [180, 100])
    pygame.display.update()
    clock.tick(1)
